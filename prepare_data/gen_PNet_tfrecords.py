...
def run(dataset_dir, net, output_dir, name='MTCNN', shuffling=False):
    ...
    if shuffling:
        # tf_filename = tf_filename.split('.')[0] + '_shuffle.' + tf_filename.split('.')[1]
        #andom.seed(12345454)
    ...
    # dataset_utils.write_label_file(labels_to_class_names, dataset_dir)ll
    print('\nFinished converting the MTCNN dataset!')


def get_dataset(dir, net='PNet'):
    #item = 'imglists/PNet/train_%s_raw.txt' % net
    item = 'imglists/PNet/train_%s.txt' % net
